...
from Equipment import Equipment # pylint: disable=import-error
from Armor import Armor # pylint: disable=import-error
from Weapon import Weapon # pylint: disable=import-error
